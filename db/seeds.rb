...
Utilisateur.create({ nom: 'Koebelin', prenom: 'Pierre', email: 'a@a', password: 'azerty', promotion: 2017, telephone: '0754218269', avatar: File.new("#{Rails.root}/public/system/exemples/avatar2.png") })
