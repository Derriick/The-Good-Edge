...
Utilisateur.create({ nom: 'Skywalker', prenom: 'Luke', email: 'damien-lo@hotmail.fr', password: 'scoledge', promotion: 2019, telephone: '0627445449', avatar: File.new("#{Rails.root}/public/system/exemples/avatar1.jpg") })
Utilisateur.create({ nom: 'Javel', prenom: 'Aude', email: 'derriick.ensiie@yahoo.com', password: 'saucisse', promotion: 2017, telephone: '0754218269', avatar: File.new("#{Rails.root}/public/system/exemples/avatar2.png") })
